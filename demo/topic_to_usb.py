...
class Modbus:
    def __init__(self):
        ...
        self.server_socket.bind(('localhost', 10005))
    ...
    def interpret(self, linear_x, angular_z):
        ...
        self.motor1_power = -linear_x + (angular_z * wheelbase )  # front right motor
        self.motor2_power = -linear_x - (angular_z * wheelbase ) # front left motor
